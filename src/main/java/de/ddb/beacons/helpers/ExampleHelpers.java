...
import de.ddb.beacons.helpers.EntityTimerProcessor.TimeoutException;
...
public class ExampleHelpers {
    ...
    static final org.slf4j.Logger logger = LoggerFactory.getLogger(ExampleHelpers.class);
     ...
     * @throws IOException if it was not possible to create a directory at the
     * given path
     */
